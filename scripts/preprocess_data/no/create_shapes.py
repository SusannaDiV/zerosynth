...
molecules_dir = "/itet-stor/sdivita/net_scratch/originale/ChemProjector/chemprojector/models/encoder/data/molecules"
...
# Get all PDB files from molecules directory
molecule_pdbs = glob(os.path.join(molecules_dir, "*.pdb"))
print(f"Found {len(molecule_pdbs)} PDB files")
