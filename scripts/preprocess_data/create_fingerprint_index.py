...
@click.option("--out", type=click.Path(path_type=pathlib.Path), default=pathlib.Path("data/processed/all/shape_pharmaco_separate_alignemntindices_20250110_150000.pkl"))
