...
cavity_file_path = r'C:\Users\s.divita\Videos\DESERT\mio\mio\data\cavity.pdb'
cavity = Chem.MolFromPDBFile(cavity_file_path, proximityBonding=False)

protein_file_path = r'C:\Users\s.divita\Videos\DESERT\mio\mio\data\protein.pdb'
...
with open(r'C:\Users\s.divita\Videos\DESERT\mio\mio\data\samples_data.pkl', 'wb') as fw:
